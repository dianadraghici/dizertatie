...
describe('ProjectService', () => {
  ...
  const PROJECTS: Project[] = [
    {id: 1, projectCode: "INTERN-19-001", projectName: "PSA Project Intern", statusId: 2, percentId: 10, startDateCalendarDTO: CALENDAR[0],endDateCalendarDTO: CALENDAR[1], statusDescription: "VALIDE", percentDescription: "100", startDateModel: new NgbDate(2018, 9, 23), endDateModel: new NgbDate(2018, 9, 29), bopString: "bop", eopString: "eop"},
    {id: 2, projectCode: "EU431-98584", projectName: "BNF - TMA JAVA JEE", statusId: 2, percentId: 10,startDateCalendarDTO: CALENDAR[0],endDateCalendarDTO: CALENDAR[2], statusDescription: "ETUDE", percentDescription: "60", startDateModel: new NgbDate(2019, 1, 23), endDateModel: new NgbDate(2019, 6, 28), bopString: "bop", eopString: "eop"}];
